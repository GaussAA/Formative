    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <div className="inline-block mb-4 px-4 py-2 bg-blue-100 text-primary rounded-full text-sm font-medium">
            VibeCoding 的最前一公里
          </div>
          ...
          <div className="bg-white rounded-3xl p-10 shadow-lg border border-gray-200 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                ...
                <p className="text-xl font-bold text-red-600">问题不在代码，而在"需求没有定型"。</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-10 shadow-lg border border-gray-200 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-3xl font-bold text-gray-900">转折：定型，发生在写代码之前</h2>
              </div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-lg">
                ...
                <div className="grid grid-cols-2 gap-4 my-6">
                  <div className="bg-green-50 rounded-xl p-5 border border-green-200">
                    <div className="font-semibold text-gray-900 mb-2">📋 明确边界的 MVP 定义</div>
                  ...
                  <div className="bg-green-50 rounded-xl p-5 border border-green-200">
                    <div className="font-semibold text-gray-900 mb-2">📊 必要的技术说明</div>
                    <p className="text-sm text-gray-600">数据库 / API / 部署配置</p>
                  </div>
                  <div className="bg-green-50 rounded-xl p-5 border border-green-200">
                    <div className="font-semibold text-gray-900 mb-2">📄 完整的开发文档</div>
                    <p className="text-sm text-gray-600">可以直接交给 AI 执行</p>
                  </div>
                </div>
